...
var request = function request(route, body) {
  var options = {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
...
document.addEventListener("DOMContentLoaded", function (event) {
  var productCardImages = document.querySelectorAll('.product-card__images .image');

  if (0 < productCardImages.length) {
    productCardImages.forEach(function (image) {
      ...
      deleteButton.addEventListener('click', function (e) {
        ...
        del.then(function (response) {
          ...
          setTimeout(function () {
            ...
            var quantity = 0;
            var price = 0;
            document.querySelectorAll('.cart__row').forEach(function (el) {
              var q = el.querySelector('.quantity').textContent;
              var p = el.querySelector('.price').textContent;
              quantity += parseInt(q);
